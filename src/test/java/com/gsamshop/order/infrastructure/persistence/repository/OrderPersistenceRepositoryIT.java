...
class OrderPersistenceRepositoryIT {
    ...
    private final OrderPersistenceRepository orderPersistenceEntityRepository;

    @Autowired
    public OrderPersistenceRepositoryIT(OrderPersistenceRepository orderPersistenceEntityRepository) {
